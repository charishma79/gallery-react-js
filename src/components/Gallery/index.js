...
class Gallery extends Component {
  state = {
    ...
    activeAlt: imagesList[0].imageAltText,
  }
  ...
  updateActiveAlt = imageAltText => {
    this.setState({activeAlt: imageAltText})
  }

  render() {
    const {activeImage, activeAlt} = this.state
    // console.log(activeAlt)
    return (
      <div className="bg-container">
        <img src={activeImage} className="nature" alt={activeAlt} />
